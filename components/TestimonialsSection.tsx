      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Découvrez les témoignages de nos clients satisfaits qui nous font confiance pour l entretien de leurs espaces.
          </p>
        </div>
                    ...
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <div className="flex items-center justify-center space-x-4">
                        <Avatar className="h-12 w-12">
                          <AvatarImage src={`https://i.pravatar.cc/150?seed=${testimonial.name}`} />
                          <AvatarFallback className="bg-green-100 text-green-700">{testimonial.initials}</AvatarFallback>
                        </Avatar>
